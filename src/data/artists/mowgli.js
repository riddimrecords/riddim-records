const info1 = `For a relatively small city, Cardiff has churned out some incredible drum and bass 
  ...
  new style to his sets.`;

const info2 = `Joining the ranks of the Riddim Records artist collective in 2017, Mowgli has 
  represented the brand both up and down the UK and internationally, and will continue 
  to tear up dancefloors for the foreseeable future.`;
...
const mowgli = {
  ...
  info: [info1, info2],
  pic: 'MowgliSquare.jpg',
};

module.exports = { mowgli };
