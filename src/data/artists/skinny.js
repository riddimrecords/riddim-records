...
import skinnyPic from '../../images/artists/SkinnySquare.jpg';

const info = (<div style={{fontSize: '18px'}}>
  <p>
    Hailing from London, Skinny has played across almost all venues in Leeds, so is no stranger behind 
  ...
  <p>
    The roster of artists he has supported includes: Randall, DJ Hype, DJ Hazard, Ed Solo, Nicky Blackmarket, 
    ...
    As well as having an ear for drum and bass, Skinny also delves into 140 dub – engaging in multiple projects 
