const info1 = `Being the youngest artist in Riddim's artist collective has not stopped Ebbens from being 
...
const info2 = `Joining the ranks of the Riddim Records artist collective in 2017, as well being one of 
...
const ebbens = {
  ...
  info: [info1, info2],
  pic: 'EbbensSquare.jpg',
};

module.exports = { ebbens };
