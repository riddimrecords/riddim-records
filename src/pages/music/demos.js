  ...
  <Layout>
    ...
    <div className="demos" style={{ marginTop: '50px' }}>
      ...
      <ul style={{ listStyleType: 'none', padding: '0', marginTop: '0' }}>
        ...
        <li>
          Leave a brief comment about who you are,
          what influenced your track(s) and any other relevant info.
        </li>
      </ul>
      <form className="demosForm" style={{ marginTop: '30px' }} action="https://formspree.io/dan@riddimrecords.co.uk" method="POST">
        ...
        <input className="demosFormLabel" type="text" name="name" placeholder="Name" />
        <label htmlFor="email" style={{ display: 'none' }}>Email:</label>
        <input className="demosFormLabel" type="email" name="email" placeholder="Email" />
        <label htmlFor="link" style={{ display: 'none' }}>Link:</label>
        <input className="demosFormLabel" type="url" name="link" placeholder="Link" />
        <label htmlFor="message" style={{ display: 'none' }}>Message:</label>
        <textarea className="demosFormLabel" rows="5" type="text" name="message" placeholder="Message" style={{ fontSize: '11px' }} />
        <br />
        <input
          type="submit"
          value="Submit"
          style={{
            width: '50%', padding: '5px', margin: '5px', border: '2px solid white', background: '#111111', color: 'white', fontWeight: 'bold',
          }}
        />
      </form>
    </div>
